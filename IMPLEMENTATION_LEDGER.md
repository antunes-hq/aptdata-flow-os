...
| F1.1 | 1 | Continuidade My Universe/Nuvem como superfície planetária humana, não-dev por padrão | planned | `docs/decisions/0005-my-universe-planetary-surface.md` | ADR 0005 + emenda 0005-a: vida/memória/reflexão por padrão; lente dev apenas opt-in | integrar refs aditivas sem recriar PWA |
