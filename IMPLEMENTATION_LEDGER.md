...
| F0.5 | 0 | Contrato de Squad Confiável, WorkPacket, EvidenceRecord, JudgeResult e MaestroDecision | proposed | `docs/contracts/squad-confiavel-workpacket.md` | contrato v0.1 criado; validação do Maestro pendente; nenhuma implementação autorizada | validar invariantes e aprovar/revisar contrato |
