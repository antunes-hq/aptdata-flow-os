...
_STOPWORDS = {
    "uma", "com", "para", "que", "dos", "das", "como", "mais", "muito",
    "isso", "esse", "essa", "este", "esta", "era", "foi", "ser", "ter",
    "está", "não", "sim", "por", "aos", "são", "seu", "sua", "ele", "ela",
    "nos", "nas", "pelo", "pela", "tem", "vai", "só", "lá", "aqui",
