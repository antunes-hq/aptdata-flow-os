...
:class:`~smart_data.plugins.manager.PluginDependencyError` is raised
...
class PostgresReader(BaseReader):
    ...
    as an :class:`~smart_data.plugins.dataset.InMemoryDataset`.
...
class PostgresWriter(BaseWriter):
    """Write an :class:`~smart_data.plugins.dataset.InMemoryDataset` to a
    PostgreSQL table.
