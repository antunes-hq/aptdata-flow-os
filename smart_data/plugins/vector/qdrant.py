...
class QdrantWriter(VectorWriter):
    ...
    def write(self, dataset: BaseDataset, **kwargs: Any) -> None:
        ...
        with trace.get_tracer("smart_data.plugins.vector").start_as_current_span(
            "QdrantWriter.write"
        ) as span:
            ...
            span.set_attribute("smart_data.vector.collection", self.collection)
            span.set_attribute("smart_data.vector.points", len(self.points))
