...
from smart_data.cli.rendering.tables import config_summary_table
from smart_data.cli.rendering.panels import yaml_preview

config_app = typer.Typer(name="config", help="Manage declarative YAML configurations.")

_STARTER_YAML = """\
# smart-data declarative pipeline configuration
metadata:
  name: my_pipeline
  version: "1.0"
