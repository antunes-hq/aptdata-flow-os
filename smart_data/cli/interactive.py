"""Interactive wizard for smart-data CLI.
...
def _wizard_list() -> None:
    ...
    from smart_data.plugins import registry, plugin_manager  # noqa: PLC0415
    from smart_data.cli.rendering.tables import systems_table, plugins_table  # noqa: PLC0415
...
def _wizard_inspect() -> None:
    ...
    from smart_data.plugins import plugin_manager  # noqa: PLC0415
    from smart_data.cli.rendering.tables import plugin_schema_table  # noqa: PLC0415
...
def _wizard_config() -> None:
    ...
    from smart_data.config.parser import YamlConfigParser  # noqa: PLC0415
    from smart_data.cli.rendering.panels import yaml_preview  # noqa: PLC0415
    from smart_data.cli.rendering.tables import config_summary_table  # noqa: PLC0415
    from pathlib import Path  # noqa: PLC0415

    action = _select("Config action:", ["Load and validate", "Generate template"])

    if action == "Generate template":
        from smart_data.cli.commands.config_cmd import _STARTER_YAML  # noqa: PLC0415
...
def _wizard_telemetry() -> None:
    ...
    from smart_data.cli.commands.telemetry_cmd import _get_telemetry_status  # noqa: PLC0415
    from smart_data.cli.rendering.tables import telemetry_status_table  # noqa: PLC0415
...
def interactive_command() -> None:
    """Launch the interactive wizard for smart-data."""
    _console.rule("[bold cyan]smart-data interactive wizard[/bold cyan]")
